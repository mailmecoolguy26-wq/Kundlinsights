...
12. **Evidence synthesis foundation** — Layer 12A provides generic immutable natal evidence nodes, edges, neutral missing-data records, traceable derived relationships, and adapters for existing Layer 2–11 facts. Layer 12B is H10-primary; Layer 12B2 adds neutral H2 resource and H11 gains contexts without H6, D10 expansion, or Ashtakavarga expansion. Layer 12C adds supplied temporal activation; Layer 12D analyzes root lineage, overlap, evidence families, mechanism families, and contradictions without recalculation, scoring, interpretation, or prediction.
