...
12. **Evidence synthesis foundation** — Layer 12A provides generic immutable natal evidence nodes, edges, neutral missing-data records, traceable derived relationships, and adapters for existing Layer 2–11 facts. Layer 12B is H10-primary; Layer 12B2 adds neutral H2 resource and H11 gains contexts; Layer 12B3 adds only audited H9 and Saturn/Venus source-predicate facts without conclusion evaluation or conjunction inference. Layer 12C adds supplied temporal activation; Layer 12D analyzes root lineage, overlap, evidence families, mechanism families, and contradictions without recalculation, scoring, interpretation, or prediction.
...
15A. **Career reading orchestrator** — composes supplied Layer 12A natal and Layer 12C-compatible temporal evidence through Layers 12–14 into a deterministic CAREER reading product. It delegates all calculation and interpretation, preserves statuses, and exposes only safe reading outputs and provenance.
