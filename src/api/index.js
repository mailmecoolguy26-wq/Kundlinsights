...
function dtoReadingDetail(reading) {
  return {
    ...dtoReadingSummary(reading),
    content: reading.content === undefined ? null : reading.content,
    ...(reading.calibratedContent === undefined ? {} : {
      calibratedContent: reading.calibratedContent,
    }),
    ...
    ...(reading.careerD10Corroboration === undefined ? {} : {
      careerD10Corroboration: reading.careerD10Corroboration,
    }),
