...
function createApi({ authVerifier, userResolver, birthProfileService, natalSummaryService = null, secureReadingService, placeResolutionService = null, entitlementService, requestIdGenerator = crypto.randomUUID, corsAllowlist = [], isReady = () => true, logger = false, bodyLimit = 16 * 1024 } = {}) {
