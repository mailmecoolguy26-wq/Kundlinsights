...
function buildCareerReading({ natal, temporal, locale = SUPPORTED_LOCALE, careerAshtakavargaStructure = null } = {}) {
  ...
  const reading = freeze({ ...baseReading, insights, ...(careerAshtakavargaStructure ? { careerAshtakavargaStructure } : {}), ...(careerAshtakavargaCorroboration ? { careerAshtakavargaCorroboration } : {}), ...(careerEvidenceSynthesis ? { careerEvidenceSynthesis } : {}) });
