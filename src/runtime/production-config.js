...
function invalid(detail = null) { const error = new Error(detail ? `Invalid production configuration: ${detail}.` : 'Invalid production configuration.'); error.code = 'INVALID_PRODUCTION_CONFIGURATION'; throw error; }
