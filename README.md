...
Layers 1 and 2 are implemented. Layer 2 is a pure Vedic sidereal coordinate classifier documented in [LAYER-2-JYOTISH-COORDINATES.md](docs/LAYER-2-JYOTISH-COORDINATES.md). Layer 1 remains a provisional provider-backed foundation; its licensing gate and contract are in [EPHEMERIS-DECISION.md](docs/EPHEMERIS-DECISION.md) and [LAYER-1-ASTRONOMICAL-ENGINE.md](docs/LAYER-1-ASTRONOMICAL-ENGINE.md).
