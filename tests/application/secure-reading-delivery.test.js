...
test('Career Insight delivery exposes a safe structured trace without internal evidence identifiers', async () => {
  ...
  assert.equal(JSON.stringify(detail.insights).match(/evidence:private|signal:private|fact:private|privateBlob|career-h10-connected/), null);
});
